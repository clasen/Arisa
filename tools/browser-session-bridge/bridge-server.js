...
function connectPage(response) {
  const encoded = Buffer.from(`<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="referrer" content="no-referrer"><title>Connect Arisa Session Bridge</title><style>body{font:16px system-ui,sans-serif;max-width:520px;margin:12vh auto;padding:24px;color:#17211c;background:#f5f6f2}main{background:white;border:1px solid #dce1dc;border-radius:16px;padding:28px}h1{font-size:24px;margin-top:0}p{line-height:1.55;color:#59645e}</style></head><body><main><h1>Connect to Arisa</h1><p>Open the Arisa Session Bridge extension in this browser profile, then choose <strong>Connect this profile</strong>.</p><p>The setup token is temporary, single-use, and remains in this page fragment rather than server logs.</p></main></body></html>`, "utf8");
