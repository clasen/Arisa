...
function buildPrompt({ ctx, artifact, transcript, toolResult }) {
  ...
  parts.push(`To deliver a file to the chat (generated by a tool or an inbound file), run_tool first if needed, then send_artifact with the returned artifactId.`);
  return parts.join("\n");
}
